...
public class DocumentoController {
    ...
    public ResponseEntity<byte[]> descargarComprobante(
        ...
        try {
            ...
            // Para utilizar la Matriz de Costos llamo al método que cruza la clase y la
            // vigencia en la matriz
            int costoBaseCalculado = licenciaValidatorService.calcularCostoLicencia(vigencia, claseEnum);

            // Si la matriz devuelve -1, significa que enviaron una vigencia o clase
            // inválida
            ...
            // Configuramos los encabezados HTTP para que el navegador sepa que es un PDF
            // descargable
            ...
            // Agrego esta línea para decirle al navegador exactamente cuánto pesa el
            // archivo y así no haya problemas en al descarga
    ...
    // Agrego un Endpoint nuevo para la T-10: Descargar un PDF con el detalle de la
    // licencia (nombre, DNI, clase, vigencia, fecha de emisión)
